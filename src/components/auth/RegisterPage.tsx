...
// ✅ Import logo
import tpnLogo from "@/user_input_files/TekPouNouLogo.png";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          {/* ✅ Logo button to return home */}
          <Link
            to="/"
            className="mb-6 flex items-center justify-center space-x-2 hover:opacity-80 transition"
            title="Retounen lakay / Go home"
          >
            <img src={tpnLogo} alt="Tek Pou Nou Logo" className="h-12 w-12" />
