  ...
  const courses = [
    {
      ...
      description:
        "Aprann pale ak ekri nan lang kreyòl ayisyen yo nan yon fason ki bon.",
    ...
    },
    {
      ...
      description:
        "Aprann kijan pou w kòmanse ak jere yon ti biznis nan Ayiti.",
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              <CardBody>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm">Enskri / Enroll</Button>
                </div>
              </CardBody>
            </Card>
          ))}
        ...
        <div className="text-center mt-12">
          ...
          <Button variant="outline">Mande yon kou / Request a Course</Button>
        </div>
      </div>
    </>
  );
