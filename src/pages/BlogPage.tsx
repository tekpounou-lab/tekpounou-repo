  ...
  const posts = [
    {
      ...
      excerpt:
        "Nou kontan anpil pou nou ka prezante nou nouvo platfòm edikasyon an ki rele Tek Pou Nou...",
      content: "",
    ...
    },
    {
      ...
      excerpt:
        "Education plays a crucial role in Haiti's development and future prosperity...",
      content: "",
    ...
    },
    {
      ...
      excerpt:
        "Kijan teknoloji ap chanje fason moun yo ap aprann nan kominote ayisyen an...",
      content: "",
                ...
                <div className="md:w-2/3">
                  <CardBody className="h-full flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button size="sm">Li plis / Read More</Button>
                    </div>
                  </CardBody>
                </div>
              </div>
