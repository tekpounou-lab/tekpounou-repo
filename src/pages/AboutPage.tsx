...
import { Card, CardContent } from "@/components/ui/Card"   // ✅ lowercase import
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <Link
              to="/"
              className="inline-block bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-medium px-4 py-2 rounded-md shadow hover:bg-gray-300 dark:hover:bg-gray-700 transition"
            >
              ← Retounen Lakay
            </Link>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {/* ✅ Button back to RootPage */}
              <Link
                to="/"
                className="inline-block bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-gray-300 dark:hover:bg-gray-700 transition"
              >
                Retounen Lakay
              </Link>
            </div>
